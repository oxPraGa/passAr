            ...
            */
                    ...
                    if (RENDER_FLAG || DRAG_INFO !== null || ANIMATION_HAPPENING || cameraMoved) {
                        ...
                        if (goahead) {
                            ...
                            for(var i = 0;i<SCENE.children.length;i++)
                              SCENE.children[i].scale.set(0.5,0.5,0.5)
            ...
            // run the rendering loop
          	...
          	requestAnimationFrame(function animate(nowMsec){
                ...
                //document.getElementsByTagName("canvas").style.h="height:480px !important";
                $("canvas").css("height","height:560px !important");
